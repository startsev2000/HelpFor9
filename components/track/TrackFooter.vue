  ...
  export default Vue.extend({
    ...
    data() {
      return {
        ...
        content: {
          'mathinfo': {
            text: 'Направление "Информатика, инженерия и математика" подойдет для всех ребят, кто хочет общаться с компьютером (и не только) на “ты”!',
            image: null
          },
          'mathec': {
            text: 'Нашел что-то для себя? Тогда на матэке тебя уже ждут!',
            image: {
              src: '/img/ui/trackfooter/mathec.png',
              position: Position.Center
            }
          },
          'math': {
            text: 'Чтобы лучше познать точные науки, формируются маленькие профильные группы, в которых преподают несколько учителей. Для тех, кто хочет совершенствовать свои знания, есть олимпиадные факультативы.',
            image: {
          ...
          'socec': {
            text: 'И “соц”, и “эк”. Так иногда говорят лицеисты соцэка. Ведь на этом направлении ты сможешь выбрать обширный учебный план и взять частичку как от социальных наук, так и от технических.',
            image: {
              src: '/img/ui/trackfact/socec.png',
              position: Position.Center
            }
          },
          'hum': {
          ...
          'sci': {
            ...
            image: {
              src: '/img/ui/trackfooter/sci.png',
              position: Position.Center
            }
          }
