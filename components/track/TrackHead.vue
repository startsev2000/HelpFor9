    ...
    data() {
      return {
        track: {
          ...
          mainQuote: {
            text: {
              'mathinfo': 'ПИТОН. Это был быстрый тест на то, программист ты или биолог.',
              'mathec': 'Отличить эндогенную переменную от экзогенной? Запросто!',
              'math': 'Нет, нет здесь уже не просто «дважды два – четыре».',
              'socec': 'И “соц”, и “эк”, как говорится…',
              'hum': 'Александр Сергеевич. Это был быстрый тест на то, пушкинист ты или просто знаешь имя и отчество Грибоедова.',
